...
<body>
 	...
 	</div><!-- fin contenido del formulario -->

	<h1 class="text-center">ODONTOGRAMA</h1>
	<ul class="nav nav-tabs" data-tabs="tabs">
	  	<li id="tabDiagnosticos" class="active"><a href="#diagnosticos" data-toggle="tab">Diagnostico</a></li>
	...
	<div id="my-tab-content" class="tab-content">
		...
		<div class="tab-pane active" id="diagnosticos" >
