...
-- Volcando datos para la tabla odontograma1.admisiones: ~2 rows (aproximadamente)
/*!40000 ALTER TABLE `admisiones` DISABLE KEYS */;
INSERT INTO `admisiones` (`Id`, `Codigo`, `Cita`, `Usuario`, `Historia`, `Fecha`, `Atendida`) VALUES
	(1, 6596905450, 59, 92654, NULL, '2016-07-22 17:38:29', b'0'),
	(2, 6668865540, 60, 92654, NULL, '2016-07-22 17:43:15', b'0'),
	(3, 3865642014, 61, 92654, NULL, '2016-07-22 17:48:13', b'0');
...
) ENGINE=InnoDB AUTO_INCREMENT=49 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='Items de antecedentes odontologicos y medicos generales';

-- Volcando datos para la tabla odontograma1.antecedentes: ~48 rows (aproximadamente)
/*!40000 ALTER TABLE `antecedentes` DISABLE KEYS */;
INSERT INTO `antecedentes` (`Id`, `Antecedente`, `Grupo`) VALUES
	(1, 'Alergias', 1),
	(2, 'Discrasias sanguíneas', 1),
	(3, 'Cardiopatías', 1),
	(4, 'Embarazo', 1),
	(5, 'Alterasiones presíon arterial', 1),
	(6, 'Toma de medicamentos', 1),
	(7, 'Tratamiento médico actual', 1),
	(8, 'Hepatitis', 1),
	(9, 'Diabetes', 1),
	(10, 'Fiebre reumática', 1),
	(11, 'HIV - SIDA', 1),
	(12, 'Inmunosupresión', 1),
	(13, 'Patologías renales', 1),
	(14, 'Patologias respiratorias', 1),
	(15, 'Trastornos gástricos', 1),
	(16, 'Trastornos emocionales', 1),
	(17, 'Sinusitis', 1),
	(18, 'Cirugías ( incluso orales )', 1),
	(19, 'Exodoncias', 1),
	(20, 'Enfermedades orales', 1),
	(21, 'Uso de protesis o aparatologia oral', 1),
	(22, 'Hábitos y otras patologías o antecedentes odontológicos o médicos', 1),
	(23, 'Familiares', 4),
	(24, 'Labio inferior', 2),
	(25, 'Labio superior', 2),
	(26, 'Comisuras', 2),
	...
	(30, 'Orofaringe', 2),
	(31, 'Paladar', 2),
	(32, 'Glándulas salivales', 2),
	(33, 'Piso de boca', 2),
	(34, 'Dorso de lengua', 2),
	(35, 'Vientre de lengua', 2),
	(36, 'Ruidos', 3),
	(37, 'Descripcion', 3),
	(38, 'Desviación', 3),
	(39, 'Descripcion', 3),
	(40, 'Cambio de volumen', 3),
	(41, 'Descripcion', 3),
	(42, 'Bloqueo mandibular', 3),
	(43, 'Descripcion', 3),
	(44, 'Limitación de apertura', 3),
	(45, 'Descripcion', 3),
	(46, 'Dolor articular', 3),
	(47, 'Descripcion', 3),
	(48, 'Dolor muscular', 3);
...
) ENGINE=InnoDB AUTO_INCREMENT=62 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='almacena las citas programadas';

-- Volcando datos para la tabla odontograma1.citas: ~4 rows (aproximadamente)
/*!40000 ALTER TABLE `citas` DISABLE KEYS */;
INSERT INTO `citas` (`Id`, `Paciente`, `Medico`, `Fecha`, `Hora`, `FechaRegistro`, `FechaCambio`, `Estado`, `Usuario`) VALUES
	(58, 1104, 11043, '2016-07-22', '16:15:00', '2016-07-22 16:12:56', '2016-07-22 16:17:36', 3, 92654),
	(59, 1104, 11043, '2016-07-22', '17:45:00', '2016-07-22 17:38:25', '2016-07-22 17:38:34', 3, 92654),
	(60, 1104, 11043, '2016-07-22', '18:00:00', '2016-07-22 17:43:11', '2016-07-22 17:43:21', 3, 92654),
	(61, 1104, 11043, '2016-07-22', '18:15:00', '2016-07-22 17:48:08', '2016-07-22 17:48:24', 3, 92654);
...
-- Volcando datos para la tabla odontograma1.eps: ~1 rows (aproximadamente)
...
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='Almacena las evoluciones que se le den a los diagnosticos del paciente';

-- Volcando datos para la tabla odontograma1.evoluciones: ~8 rows (aproximadamente)
/*!40000 ALTER TABLE `evoluciones` DISABLE KEYS */;
INSERT INTO `evoluciones` (`Codigo`, `Diagnostico`, `Tratamiento`, `Descripcion`, `Fecha`, `Finish`) VALUES
	(1, 1, 14, 'inicio tratamiento', '2016-07-22 17:41:28', b'0'),
	(2, 1, 14, 'terminar tratamiento', '2016-07-22 17:41:37', b'1'),
	(3, 11, 12, 'realizando tratamiento', '2016-07-22 17:41:50', b'1'),
	(4, 4, 16, 'iniciotratamiento diente ', '2016-07-22 17:42:06', b'0'),
	(5, 4, 16, 'finalizando tratamiento diente ', '2016-07-22 17:42:18', b'1'),
	(6, 7, 19, 'realizando tratamiento diente', '2016-07-22 17:42:33', b'1'),
	(7, 31, 33, 'realizando tratamiento general diente', '2016-07-22 17:46:44', b'1'),
	(8, 24, 30, 'curando caries', '2016-07-22 17:46:58', b'1'),
	(9, 20, 28, 'terminando tratamiento general', '2016-07-22 17:47:15', b'1');
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='Almacena las diferentes historias odontologicas que se abren a los pacientes';
...
INSERT INTO `historias` (`Codigo`, `Paciente`, `Medico`, `FechaApertura`, `Estado`, `Padre`) VALUES
	(1, 1104, 11043, '2016-07-22 17:38:34', b'0', NULL),
	(2, 1104, 11043, '2016-07-22 17:43:20', b'0', 1),
	(3, 1104, 11043, '2016-07-22 17:48:24', b'0', 2);
...
-- Volcando datos para la tabla odontograma1.ips: ~1 rows (aproximadamente)
...
INSERT INTO `medicos` (`Id`, `Tipoid`, `Nombres`, `Apellidos`, `Edad`, `Sexo`, `Telefono`, `Celular`, `Direccion`, `Usuario`, `Password`, `Estado`) VALUES
	...
	(11044, 'CC', 'maria', 'morales', 24, 'F', '282000', '300564784', 'sincelejo', 'maria', '', b'1');
...
-- Volcando datos para la tabla odontograma1.pacienteprocedures: ~38 rows (aproximadamente)
...
INSERT INTO `pacienteprocedures` (`Id`, `Fecha`, `Historia`, `Diente`, `Zone`, `Procedure`, `Tipe`, `Cause`) VALUES
	(1, '2016-07-22 17:38:42', 1, NULL, 11, 3, 1, NULL),
	(2, '2016-07-22 17:38:47', 1, NULL, 11, 4, 1, NULL),
	(3, '2016-07-22 17:38:49', 1, NULL, 11, 5, 1, NULL),
	(4, '2016-07-22 17:38:53', 1, 14, 4, 13, 1, NULL),
	(5, '2016-07-22 17:38:56', 1, 15, 4, 15, 1, NULL),
	(6, '2016-07-22 17:39:00', 1, 16, 1, 16, 1, NULL),
	(7, '2016-07-22 17:39:03', 1, 18, 3, 17, 1, NULL),
	(8, '2016-07-22 17:39:05', 1, 20, 5, 18, 1, NULL),
	(9, '2016-07-22 17:39:07', 1, 21, 5, 19, 1, NULL),
	(10, '2016-07-22 17:39:56', 1, 22, 10, 9, 1, NULL),
	(11, '2016-07-22 17:39:58', 1, 23, 10, 9, 1, NULL),
	(12, '2016-07-22 17:40:45', 1, 23, 10, 125, 2, 11),
	(13, '2016-07-22 17:40:48', 1, 22, 10, 125, 2, 10),
	(14, '2016-07-22 17:40:53', 1, NULL, 11, 124, 2, 1),
	(15, '2016-07-22 17:40:56', 1, NULL, 11, 124, 2, 2),
	(16, '2016-07-22 17:41:00', 1, 14, 4, 121, 2, 4),
	(17, '2016-07-22 17:41:02', 1, 15, 4, 121, 2, 5),
	(18, '2016-07-22 17:41:06', 1, 16, 1, 121, 2, 6),
	(19, '2016-07-22 17:41:11', 1, 18, 3, 121, 2, 7),
	(20, '2016-07-22 17:38:47', 2, NULL, 11, 4, 1, NULL),
	(21, '2016-07-22 17:39:56', 2, 22, 10, 9, 1, NULL),
	(22, '2016-07-22 17:39:07', 2, 21, 5, 19, 1, NULL),
	(23, '2016-07-22 17:39:05', 2, 20, 5, 18, 1, NULL),
	(24, '2016-07-22 17:39:00', 2, 16, 1, 16, 1, NULL),
	(25, '2016-07-22 17:38:56', 2, 15, 4, 15, 1, NULL),
	(26, '2016-07-22 17:38:49', 2, NULL, 11, 5, 1, NULL),
	(28, '2016-07-22 17:40:56', 2, NULL, 11, 124, 2, 20),
	(29, '2016-07-22 17:41:02', 2, 15, 4, 121, 2, 25),
	(30, '2016-07-22 17:41:06', 2, 16, 1, 121, 2, 24),
	(31, '2016-07-22 17:45:57', 2, 14, 10, 9, 1, NULL),
	(32, '2016-07-22 17:46:02', 2, 18, 10, 9, 1, NULL),
	(33, '2016-07-22 17:46:18', 2, 14, 10, 125, 2, 31),
	(34, '2016-07-22 17:46:20', 2, 18, 10, 125, 2, 32),
	(35, '2016-07-22 17:38:49', 3, NULL, 11, 5, 1, NULL),
	(36, '2016-07-22 17:38:56', 3, 15, 4, 15, 1, NULL),
	(37, '2016-07-22 17:46:02', 3, 18, 10, 9, 1, NULL),
	(38, '2016-07-22 17:39:05', 3, 20, 5, 18, 1, NULL),
	(39, '2016-07-22 17:39:07', 3, 21, 5, 19, 1, NULL),
	(40, '2016-07-22 17:39:56', 3, 22, 10, 9, 1, NULL),
	(41, '2016-07-22 17:41:02', 3, 15, 4, 121, 2, 36),
	(42, '2016-07-22 17:46:20', 3, 18, 10, 125, 2, 37);
...
-- Volcando datos para la tabla odontograma1.pacientes: ~2 rows (aproximadamente)
...
INSERT INTO `pacientes` (`Id`, `Tipoid`, `Nombres`, `Apellidos`, `Edad`, `Sexo`, `Telefono`, `Celular`, `Direccion`, `Ocupacion`, `EstadoCivil`, `Municipio`, `FechaNacimiento`, `Responsable`, `TelResponsable`, `Estado`, `TipPaciente`, `Ips`, `Eps`) VALUES
	...
	(1104, 'CC', 'carlos', 'guzman', 24, 'M', '274563', '300', 'sincelejo', 'independiente', 'Soltero', 'Sincelejo', '2001-07-01', NULL, NULL, b'1', 1, 1, 1),
	(789456, 'CC', 'una manzana', 'una manzana', 789456, 'M', '', '789456', 'una manzana', '', 'Soltero', 'una manzana', '1991-09-05', '', '', b'1', 1, 1, 1);
...
-- Volcando datos para la tabla odontograma1.tipoantecedentes: ~3 rows (aproximadamente)
