...
CREATE TABLE IF NOT EXISTS `pacienteprocedures` (
  ...
  PRIMARY KEY (`Id`),
  UNIQUE KEY `Paciente_Diente_Zone_Procedure` (`Paciente`,`Diente`,`Zone`,`Procedure`),
...
) ENGINE=InnoDB AUTO_INCREMENT=163 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci;

-- Volcando datos para la tabla odontograma1.pacienteprocedures: ~17 rows (aproximadamente)
...
INSERT INTO `pacienteprocedures` (`Id`, `Fecha`, `Paciente`, `Diente`, `Zone`, `Procedure`, `Tipe`) VALUES
	...
	(82, '2016-04-21 16:53:54', 1104, 21, 1, 13, 1),
	(85, '2016-04-26 12:13:39', 1104, 3, 8, 121, 2),
	(130, '2016-04-27 17:53:45', 1104, 23, 9, 2, 1),
	(131, '2016-04-27 17:55:02', 1104, NULL, 11, 3, 1),
	(156, '2016-04-27 17:55:41', 1104, 22, 9, 2, 1),
	(158, '2016-04-27 17:57:00', 1104, NULL, 11, 4, 1),
	(159, '2016-04-27 17:57:29', 1104, 38, 8, 5, 1),
	(160, '2016-04-27 18:07:39', 1104, 3, 9, 2, 1),
	(162, '2016-04-27 18:08:40', 1104, 23, 1, 13, 1);
