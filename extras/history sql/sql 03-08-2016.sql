...
) ENGINE=InnoDB AUTO_INCREMENT=256 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='Almacena los antecedentes odontologicos y generales del paciente';
...
INSERT INTO `pacientes` (`Id`, `Tipoid`, `Nombres`, `Apellidos`, `Edad`, `Sexo`, `Telefono`, `Celular`, `Direccion`, `Ocupacion`, `EstadoCivil`, `Municipio`, `FechaNacimiento`, `Responsable`, `TelResponsable`, `Estado`, `TipPaciente`, `Ips`, `Eps`) VALUES
	...
	(1104379214, 'CC', 'pedro', 'perez', 25, 'M', '281654', '31358163', '20 de julio', 'programador', 'Soltero', 'sincelejo', '1991-09-05', '', '', b'1', 1, 1, 1);
...
-- Volcando datos para la tabla odontograma1.tipopacientes: ~1 rows (aproximadamente)
