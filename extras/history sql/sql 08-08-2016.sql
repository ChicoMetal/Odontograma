...
) ENGINE=InnoDB AUTO_INCREMENT=68 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='almacena las citas programadas';
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='Almacena las evoluciones que se le den a los diagnosticos del paciente';
...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='Almacena las diferentes historias odontologicas que se abren a los pacientes';
...
-- Volcando datos para la tabla odontograma1.logs: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `logs` DISABLE KEYS */;
INSERT INTO `logs` (`id`, `usuario`, `token`, `Ingreso`, `Salida`, `estado`) VALUES
	(4, 'ana', 'c07835384075cf0e2592b593d205f053', '2016-08-08 18:01:40', NULL, b'1');
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='Aqui se almacena la razon por la que el paciente acude a consulta';
...
CREATE TABLE IF NOT EXISTS `usuarios` (
  ...
  `Password` varchar(100) COLLATE utf8_spanish2_ci NOT NULL,
  `Estado` bit(1) NOT NULL DEFAULT b'1',
  `Tipo` varchar(4) COLLATE utf8_spanish2_ci NOT NULL COMMENT 'Medico( 1111 ), Auxiliar(0011)',
  PRIMARY KEY (`Id`),
  UNIQUE KEY `Usuario` (`Usuario`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci;
