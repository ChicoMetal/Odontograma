-- --------------------------------------------------------
-- Host:                         127.0.0.1
-- Versión del servidor:         5.6.26 - Source distribution
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='Almacena las evoluciones que se le den a los diagnosticos del paciente';
...
CREATE TABLE IF NOT EXISTS `pacienteprocedures` (
  ...
  PRIMARY KEY (`Id`),
  UNIQUE KEY `Paciente_Diente_Zone_Procedure` (`Historia`,`Diente`,`Zone`,`Procedure`),
...
) ENGINE=InnoDB AUTO_INCREMENT=291 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci;
