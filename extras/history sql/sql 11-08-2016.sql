...
) ENGINE=InnoDB AUTO_INCREMENT=70 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='almacena las citas programadas';

-- Volcando datos para la tabla odontograma1.citas: ~2 rows (aproximadamente)
...
-- Volcando datos para la tabla odontograma1.evoluciones: ~2 rows (aproximadamente)
...
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='Almacena las diferentes historias odontologicas que se abren a los pacientes';

-- Volcando datos para la tabla odontograma1.historias: ~2 rows (aproximadamente)
...
-- Volcando datos para la tabla odontograma1.logfails: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla odontograma1.logs: ~6 rows (aproximadamente)
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='Aqui se almacena la razon por la que el paciente acude a consulta';

-- Volcando datos para la tabla odontograma1.motivosconsulta: ~2 rows (aproximadamente)
...
-- Volcando datos para la tabla odontograma1.pacienteprocedures: ~24 rows (aproximadamente)
