...
-- Volcando datos para la tabla odontograma1.pacienteprocedures: ~4 rows (aproximadamente)
/*!40000 ALTER TABLE `pacienteprocedures` DISABLE KEYS */;
INSERT INTO `pacienteprocedures` (`Id`, `Fecha`, `Paciente`, `Diente`, `Zone`, `Diagnostico`, `Tipe`) VALUES
