...
-- Volcando datos para la tabla odontograma1.admisiones: ~5 rows (aproximadamente)
...
INSERT INTO `admisiones` (`Id`, `Codigo`, `Cita`, `Usuario`, `Historia`, `Fecha`, `Atendida`) VALUES
	...
	(22, 5546603973, 19, 92654, NULL, '2016-07-13 11:00:27', b'0'),
	(23, 7914138448, 20, 92654, NULL, '2016-07-15 16:29:43', b'0'),
	(24, 3352453579, 22, 92654, NULL, '2016-07-15 18:11:06', b'0');
...
CREATE TABLE IF NOT EXISTS `antecedentes` (
  ...
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=24 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='Items de antecedentes odontologicos y medicos generales';

-- Volcando datos para la tabla odontograma1.antecedentes: ~21 rows (aproximadamente)
...
INSERT INTO `antecedentes` (`Id`, `Antecedente`) VALUES
	...
	(3, 'Cardiopatías'),
	(4, 'Embarazo'),
	(5, 'Alterasiones presíon arterial'),
	...
	(11, 'HIV - SIDA'),
	(12, 'Inmunosupresión'),
	(13, 'Patologías renales'),
	(14, 'Patologias respiratorias'),
	(15, 'Trastornos gástricos'),
	(16, 'Trastornos emocionales'),
	(17, 'Sinusitis'),
	(18, 'Cirugías ( incluso orales )'),
	(19, 'Exodoncias'),
	(20, 'Enfermedades orales'),
	(21, 'Uso de protesis o aparatologia oral'),
	(22, 'Otros'),
	(23, 'Familiares');
...
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='almacena las citas programadas';

-- Volcando datos para la tabla odontograma1.citas: ~9 rows (aproximadamente)
/*!40000 ALTER TABLE `citas` DISABLE KEYS */;
INSERT INTO `citas` (`Id`, `Paciente`, `Medico`, `Fecha`, `Hora`, `FechaRegistro`, `FechaCambio`, `Estado`, `Usuario`) VALUES
	(5, 1104, 11043, '2016-06-24', '06:30:00', '2016-06-23 22:25:02', '2016-06-23 22:25:02', 1, 92654),
	(13, 1104, 11043, '2016-06-24', '06:45:00', '2016-06-23 22:44:31', '2016-06-23 22:44:31', 1, 92654),
	(14, 1104, 11043, '2016-06-25', '06:45:00', '2016-06-23 22:44:50', '2016-06-23 22:44:50', 1, 92654),
	(15, 1104, 11043, '2016-06-26', '06:00:00', '2016-06-23 23:04:37', '2016-06-23 23:04:37', 1, 92654),
	(16, 1104, 11043, '2016-06-23', '22:00:00', '2016-06-23 23:21:50', '2016-06-23 23:21:50', 1, 92654),
	(17, 1104, 11043, '2016-06-24', '15:30:00', '2016-06-24 15:10:22', '2016-06-24 15:10:22', 1, 92654),
	(18, 1104, 11043, '2016-07-14', '08:00:00', '2016-07-13 10:56:41', '2016-07-13 10:56:41', 1, 92654),
	(19, 1104, 11043, '2016-07-13', '12:00:00', '2016-07-13 11:00:19', '2016-07-13 11:00:19', 1, 92654),
	(20, 1104, 11043, '2016-07-15', '06:45:00', '2016-07-15 16:29:37', '2016-07-15 16:29:37', 1, 92654),
	(21, 1104, 11043, '2016-07-15', '06:30:00', '2016-07-15 17:55:19', '2016-07-15 17:55:19', 1, 92654),
	(22, 1104, 11043, '2016-07-15', '07:00:00', '2016-07-15 18:02:48', '2016-07-15 18:39:48', 3, 92654);
...
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='Almacena las evoluciones que se le den a los diagnosticos del paciente';

-- Volcando datos para la tabla odontograma1.evoluciones: ~6 rows (aproximadamente)
...
) ENGINE=InnoDB AUTO_INCREMENT=79 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='Almacena las diferentes historias odontologicas que se abren a los pacientes';

-- Volcando datos para la tabla odontograma1.historias: ~4 rows (aproximadamente)
...
INSERT INTO `historias` (`Codigo`, `Paciente`, `Medico`, `FechaApertura`, `Estado`, `Padre`) VALUES
	...
	(75, 1104, 11043, '2016-07-13 11:00:44', b'1', 2),
	(76, 1104, 11043, '2016-07-15 16:29:50', b'0', 2),
	(78, 1104, 11043, '2016-07-15 18:39:46', b'1', 2);
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='Aqui se almacena la razon por la que el paciente acude a consulta';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='Almacena los antecedentes odontologicos y generales del paciente';

-- Volcando datos para la tabla odontograma1.pacienteantecedentes: ~0 rows (aproximadamente)
...
) ENGINE=InnoDB AUTO_INCREMENT=1662 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci;

-- Volcando datos para la tabla odontograma1.pacienteprocedures: ~182 rows (aproximadamente)
...
INSERT INTO `pacienteprocedures` (`Id`, `Fecha`, `Historia`, `Diente`, `Zone`, `Procedure`, `Tipe`, `Cause`) VALUES
	...
	(1526, '2016-05-26 16:53:38', 75, 3, 1, 18, 1, NULL),
	(1527, '2016-04-27 17:55:41', 75, 22, 9, 2, 1, NULL),
	(1528, '2016-04-27 18:08:40', 75, 23, 1, 13, 1, NULL),
	(1529, '2016-04-27 17:53:45', 75, 23, 9, 2, 1, NULL),
	(1530, '2016-06-22 21:53:47', 75, 24, 8, 33, 1, NULL),
	(1531, '2016-05-30 20:07:45', 75, 31, 1, 6, 1, NULL),
	(1532, '2016-05-30 20:07:48', 75, 31, 3, 6, 1, NULL),
	(1533, '2016-05-30 20:07:53', 75, 31, 4, 6, 1, NULL),
	(1534, '2016-05-30 20:07:36', 75, 31, 5, 16, 1, NULL),
	(1535, '2016-05-30 19:03:34', 75, 33, 9, 2, 1, NULL),
	(1536, '2016-06-06 01:11:10', 75, 38, 1, 13, 1, NULL),
	(1537, '2016-04-27 17:57:29', 75, 38, 8, 5, 1, NULL),
	(1538, '2016-05-02 16:56:09', 75, 39, 1, 16, 1, NULL),
	(1539, '2016-05-02 16:57:01', 75, 39, 2, 19, 1, NULL),
	(1540, '2016-04-21 11:55:15', 75, 40, 1, 13, 1, NULL),
	(1541, '2016-04-21 11:55:21', 75, 40, 5, 13, 1, NULL),
	(1542, '2016-05-26 16:39:47', 75, 22, 7, 18, 1, NULL),
	(1543, '2016-05-26 16:39:38', 75, 22, 5, 17, 1, NULL),
	(1544, '2016-05-02 17:30:54', 75, 5, 8, 1, 1, NULL),
	(1545, '2016-05-02 17:30:49', 75, 5, 9, 2, 1, NULL),
	(1546, '2016-05-02 16:53:09', 75, 7, 8, 1, 1, NULL),
	(1547, '2016-05-02 16:59:34', 75, 14, 1, 14, 1, NULL),
	(1548, '2016-05-02 16:59:44', 75, 14, 2, 16, 1, NULL),
	(1549, '2016-05-02 16:59:51', 75, 14, 3, 18, 1, NULL),
	(1550, '2016-05-02 16:59:57', 75, 15, 8, 20, 1, NULL),
	(1551, '2016-04-20 17:44:46', 75, 18, 1, 13, 1, NULL),
	(1552, '2016-05-26 16:39:52', 75, 18, 3, 18, 1, NULL),
	(1553, '2016-04-21 16:53:54', 75, 21, 1, 13, 1, NULL),
	(1554, '2016-05-02 16:40:43', 75, 21, 8, 1, 1, NULL),
	(1555, '2016-04-21 11:08:21', 75, 22, 1, 13, 1, NULL),
	(1556, '2016-05-26 16:39:41', 75, 22, 2, 17, 1, NULL),
	(1557, '2016-05-26 16:39:32', 75, 22, 4, 17, 1, NULL),
	(1558, '2016-05-26 17:46:49', 75, 44, 10, 9, 1, NULL),
	(1559, '2016-06-23 15:08:34', 75, 7, 8, 122, 2, 1546),
	(1560, '2016-05-26 16:53:38', 76, 3, 1, 18, 1, NULL),
	(1561, '2016-04-27 17:55:41', 76, 22, 9, 2, 1, NULL),
	(1562, '2016-04-27 18:08:40', 76, 23, 1, 13, 1, NULL),
	(1563, '2016-04-27 17:53:45', 76, 23, 9, 2, 1, NULL),
	(1564, '2016-06-22 21:53:47', 76, 24, 8, 33, 1, NULL),
	(1565, '2016-05-30 20:07:45', 76, 31, 1, 6, 1, NULL),
	(1566, '2016-05-30 20:07:48', 76, 31, 3, 6, 1, NULL),
	(1567, '2016-05-30 20:07:53', 76, 31, 4, 6, 1, NULL),
	(1568, '2016-05-30 20:07:36', 76, 31, 5, 16, 1, NULL),
	(1569, '2016-05-30 19:03:34', 76, 33, 9, 2, 1, NULL),
	(1570, '2016-06-06 01:11:10', 76, 38, 1, 13, 1, NULL),
	(1571, '2016-04-27 17:57:29', 76, 38, 8, 5, 1, NULL),
	(1572, '2016-05-02 16:56:09', 76, 39, 1, 16, 1, NULL),
	(1573, '2016-05-02 16:57:01', 76, 39, 2, 19, 1, NULL),
	(1574, '2016-04-21 11:55:15', 76, 40, 1, 13, 1, NULL),
	(1575, '2016-04-21 11:55:21', 76, 40, 5, 13, 1, NULL),
	(1576, '2016-05-26 16:39:47', 76, 22, 7, 18, 1, NULL),
	(1577, '2016-05-26 16:39:38', 76, 22, 5, 17, 1, NULL),
	(1578, '2016-05-02 17:30:54', 76, 5, 8, 1, 1, NULL),
	(1579, '2016-05-02 17:30:49', 76, 5, 9, 2, 1, NULL),
	(1580, '2016-05-02 16:53:09', 76, 7, 8, 1, 1, NULL),
	(1581, '2016-05-02 16:59:34', 76, 14, 1, 14, 1, NULL),
	(1582, '2016-05-02 16:59:44', 76, 14, 2, 16, 1, NULL),
	(1583, '2016-05-02 16:59:51', 76, 14, 3, 18, 1, NULL),
	(1584, '2016-05-02 16:59:57', 76, 15, 8, 20, 1, NULL),
	(1585, '2016-04-20 17:44:46', 76, 18, 1, 13, 1, NULL),
	(1586, '2016-05-26 16:39:52', 76, 18, 3, 18, 1, NULL),
	(1587, '2016-04-21 16:53:54', 76, 21, 1, 13, 1, NULL),
	(1588, '2016-05-02 16:40:43', 76, 21, 8, 1, 1, NULL),
	(1589, '2016-04-21 11:08:21', 76, 22, 1, 13, 1, NULL),
	(1590, '2016-05-26 16:39:41', 76, 22, 2, 17, 1, NULL),
	(1591, '2016-05-26 16:39:32', 76, 22, 4, 17, 1, NULL),
	(1592, '2016-05-26 17:46:49', 76, 44, 10, 9, 1, NULL),
	(1593, '2016-06-23 15:08:34', 76, 7, 8, 122, 2, 1580),
	(1628, '2016-05-26 16:53:38', 78, 3, 1, 18, 1, NULL),
	(1629, '2016-04-27 17:55:41', 78, 22, 9, 2, 1, NULL),
	(1630, '2016-04-27 18:08:40', 78, 23, 1, 13, 1, NULL),
	(1631, '2016-04-27 17:53:45', 78, 23, 9, 2, 1, NULL),
	(1632, '2016-06-22 21:53:47', 78, 24, 8, 33, 1, NULL),
	(1633, '2016-05-30 20:07:45', 78, 31, 1, 6, 1, NULL),
	(1634, '2016-05-30 20:07:48', 78, 31, 3, 6, 1, NULL),
	(1635, '2016-05-30 20:07:53', 78, 31, 4, 6, 1, NULL),
	(1636, '2016-05-30 20:07:36', 78, 31, 5, 16, 1, NULL),
	(1637, '2016-05-30 19:03:34', 78, 33, 9, 2, 1, NULL),
	(1638, '2016-06-06 01:11:10', 78, 38, 1, 13, 1, NULL),
	(1639, '2016-04-27 17:57:29', 78, 38, 8, 5, 1, NULL),
	(1640, '2016-05-02 16:56:09', 78, 39, 1, 16, 1, NULL),
	(1641, '2016-05-02 16:57:01', 78, 39, 2, 19, 1, NULL),
	(1642, '2016-04-21 11:55:15', 78, 40, 1, 13, 1, NULL),
	(1643, '2016-04-21 11:55:21', 78, 40, 5, 13, 1, NULL),
	(1644, '2016-05-26 16:39:47', 78, 22, 7, 18, 1, NULL),
	(1645, '2016-05-26 16:39:38', 78, 22, 5, 17, 1, NULL),
	(1646, '2016-05-02 17:30:54', 78, 5, 8, 1, 1, NULL),
	(1647, '2016-05-02 17:30:49', 78, 5, 9, 2, 1, NULL),
	(1648, '2016-05-02 16:53:09', 78, 7, 8, 1, 1, NULL),
	(1649, '2016-05-02 16:59:34', 78, 14, 1, 14, 1, NULL),
	(1650, '2016-05-02 16:59:44', 78, 14, 2, 16, 1, NULL),
	(1651, '2016-05-02 16:59:51', 78, 14, 3, 18, 1, NULL),
	(1652, '2016-05-02 16:59:57', 78, 15, 8, 20, 1, NULL),
	(1653, '2016-04-20 17:44:46', 78, 18, 1, 13, 1, NULL),
	(1654, '2016-05-26 16:39:52', 78, 18, 3, 18, 1, NULL),
	(1655, '2016-04-21 16:53:54', 78, 21, 1, 13, 1, NULL),
	(1656, '2016-05-02 16:40:43', 78, 21, 8, 1, 1, NULL),
	(1657, '2016-04-21 11:08:21', 78, 22, 1, 13, 1, NULL),
	(1658, '2016-05-26 16:39:41', 78, 22, 2, 17, 1, NULL),
	(1659, '2016-05-26 16:39:32', 78, 22, 4, 17, 1, NULL),
	(1660, '2016-05-26 17:46:49', 78, 44, 10, 9, 1, NULL),
	(1661, '2016-06-23 15:08:34', 78, 7, 8, 122, 2, 1648);
