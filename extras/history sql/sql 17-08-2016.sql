...
INSERT INTO `admisiones` (`Id`, `Codigo`, `Cita`, `Usuario`, `Historia`, `Fecha`, `Atendida`) VALUES
	(1, 9428756740, 66, 92654, NULL, '2016-08-05 19:27:41', b'0'),
	(2, 9881723008, 67, 92654, NULL, '2016-08-05 19:35:34', b'0'),
	(3, 4207396333, 68, 92654, NULL, '2016-08-11 16:33:17', b'0'),
	(4, 8157539427, 69, 92654, NULL, '2016-08-11 16:44:15', b'0'),
	(5, 7496364905, 70, 92654, NULL, '2016-08-16 15:39:43', b'0'),
	(6, 9093546310, 71, 92654, NULL, '2016-08-17 16:18:09', b'0');
...
) ENGINE=InnoDB AUTO_INCREMENT=72 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='almacena las citas programadas';
...
INSERT INTO `citas` (`Id`, `Paciente`, `Medico`, `Fecha`, `Hora`, `FechaRegistro`, `FechaCambio`, `Estado`, `Usuario`) VALUES
	(66, 1104379214, 11043, '2016-08-05', '19:30:00', '2016-08-05 19:27:35', '2016-08-05 19:29:06', 3, 92654),
	(67, 1104379214, 11043, '2016-08-05', '19:45:00', '2016-08-05 19:35:29', '2016-08-05 19:36:07', 3, 92654),
	(68, 1104379214, 11043, '2016-08-11', '16:45:00', '2016-08-11 16:33:03', '2016-08-11 16:33:17', 2, 92654),
	(69, 1104379214, 11044, '2016-08-11', '16:45:00', '2016-08-11 16:42:58', '2016-08-11 16:49:27', 3, 92654),
	(70, 1104379214, 11044, '2016-08-16', '15:45:00', '2016-08-16 15:39:36', '2016-08-16 15:40:24', 3, 92654),
	(71, 1104379214, 11044, '2016-08-17', '16:30:00', '2016-08-17 16:18:00', '2016-08-17 16:18:50', 3, 92654);
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='Almacena las evoluciones que se le den a los diagnosticos del paciente';

-- Volcando datos para la tabla odontograma1.evoluciones: ~3 rows (aproximadamente)
...
INSERT INTO `evoluciones` (`Codigo`, `Diagnostico`, `Tratamiento`, `Descripcion`, `Fecha`, `Finish`) VALUES
	(1, 51, 52, 'realizando tratamiento', '2016-08-05 19:34:42', b'1'),
	(2, 44, 55, 'haciendo tratamiento general', '2016-08-05 19:35:01', b'1'),
	(3, 74, 81, 'haciendo evolucion con plataforma', '2016-08-11 16:50:56', b'1');
...
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='Almacena las diferentes historias odontologicas que se abren a los pacientes';
...
INSERT INTO `historias` (`Codigo`, `Paciente`, `Medico`, `FechaApertura`, `Estado`, `Padre`) VALUES
	(5, 1104379214, 11043, '2016-08-05 19:29:06', b'0', NULL),
	(6, 1104379214, 11043, '2016-08-05 19:36:06', b'1', 5),
	(7, 1104379214, 11044, '2016-08-11 16:49:26', b'0', 6),
	(8, 1104379214, 11044, '2016-08-16 15:40:24', b'1', 7),
	(9, 1104379214, 11044, '2016-08-17 16:18:49', b'1', 8);
...
CREATE TABLE IF NOT EXISTS `logfails` (
  ...
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='Se guardan los datos de los inicios de sesion fallidos';
...
-- Volcando datos para la tabla odontograma1.logs: ~46 rows (aproximadamente)
...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='Aqui se almacena la razon por la que el paciente acude a consulta';

-- Volcando datos para la tabla odontograma1.motivosconsulta: ~4 rows (aproximadamente)
/*!40000 ALTER TABLE `motivosconsulta` DISABLE KEYS */;
INSERT INTO `motivosconsulta` (`Id`, `Motivo`, `MotivoAmpliado`, `Cita`) VALUES
	(2, 'control', 'control anual', 66),
	(3, 'nueva consulta', 'segunda consulta anual', 67),
	(4, 'consult general ', 'consulta general actual', 69),
	(5, 'consulta general', 'consulta anual', 70),
	(6, 'control', 'control anual', 71);
...
-- Volcando datos para la tabla odontograma1.pacienteprocedures: ~53 rows (aproximadamente)
...
INSERT INTO `pacienteprocedures` (`Id`, `Fecha`, `Historia`, `Diente`, `Zone`, `Procedure`, `Tipe`, `Cause`) VALUES
	(43, '2016-08-05 19:29:17', 5, 20, 8, 1, 1, NULL),
	(44, '2016-08-05 19:29:20', 5, NULL, 11, 3, 1, NULL),
	(45, '2016-08-05 19:32:38', 5, NULL, 11, 4, 1, NULL),
	(46, '2016-08-05 19:32:44', 5, 20, 1, 14, 1, NULL),
	(47, '2016-08-05 19:32:47', 5, 21, 7, 16, 1, NULL),
	(48, '2016-08-05 19:32:48', 5, 21, 2, 16, 1, NULL),
	(49, '2016-08-05 19:32:51', 5, 22, 3, 17, 1, NULL),
	(50, '2016-08-05 19:32:52', 5, 22, 2, 17, 1, NULL),
	(51, '2016-08-05 19:32:55', 5, 18, 1, 19, 1, NULL),
	(52, '2016-08-05 19:33:25', 5, 18, 1, 121, 2, 51),
	(53, '2016-08-05 19:33:29', 5, 20, 1, 121, 2, 46),
	(54, '2016-08-05 19:33:39', 5, NULL, 11, 124, 2, 45),
	(55, '2016-08-05 19:33:41', 5, NULL, 11, 124, 2, 44),
	(56, '2016-08-05 19:33:50', 5, NULL, 11, 5, 1, NULL),
	(61, '2016-08-05 19:29:17', 6, 20, 8, 1, 1, NULL),
	(62, '2016-08-05 19:32:52', 6, 22, 2, 17, 1, NULL),
	(63, '2016-08-05 19:32:51', 6, 22, 3, 17, 1, NULL),
	(64, '2016-08-05 19:32:48', 6, 21, 2, 16, 1, NULL),
	(65, '2016-08-05 19:32:47', 6, 21, 7, 16, 1, NULL),
	(66, '2016-08-05 19:32:44', 6, 20, 1, 14, 1, NULL),
	(67, '2016-08-05 19:32:38', 6, NULL, 11, 4, 1, NULL),
	(68, '2016-08-05 19:33:50', 6, NULL, 11, 5, 1, NULL),
	(69, '2016-08-05 19:33:29', 6, 20, 1, 121, 2, 66),
	(70, '2016-08-05 19:33:39', 6, NULL, 11, 124, 2, 67),
	(71, '2016-08-05 19:32:38', 7, NULL, 11, 4, 1, NULL),
	(72, '2016-08-05 19:32:52', 7, 22, 2, 17, 1, NULL),
	(73, '2016-08-05 19:32:47', 7, 21, 7, 16, 1, NULL),
	(74, '2016-08-05 19:32:48', 7, 21, 2, 16, 1, NULL),
	(75, '2016-08-05 19:29:17', 7, 20, 8, 1, 1, NULL),
	(76, '2016-08-05 19:32:44', 7, 20, 1, 14, 1, NULL),
	(77, '2016-08-05 19:33:50', 7, NULL, 11, 5, 1, NULL),
	(78, '2016-08-05 19:32:51', 7, 22, 3, 17, 1, NULL),
	(79, '2016-08-05 19:33:29', 7, 20, 1, 121, 2, 76),
	(80, '2016-08-05 19:33:39', 7, NULL, 11, 124, 2, 71),
	(81, '2016-08-11 16:50:34', 7, 21, 2, 121, 2, 74),
	(82, '2016-08-05 19:32:38', 8, NULL, 11, 4, 1, NULL),
	(83, '2016-08-05 19:33:50', 8, NULL, 11, 5, 1, NULL),
	(84, '2016-08-05 19:32:44', 8, 20, 1, 14, 1, NULL),
	(85, '2016-08-05 19:29:17', 8, 20, 8, 1, 1, NULL),
	(86, '2016-08-05 19:32:47', 8, 21, 7, 16, 1, NULL),
	(87, '2016-08-05 19:32:52', 8, 22, 2, 17, 1, NULL),
	(88, '2016-08-05 19:32:51', 8, 22, 3, 17, 1, NULL),
	(89, '2016-08-05 19:33:39', 8, NULL, 11, 124, 2, 82),
	(90, '2016-08-05 19:33:29', 8, 20, 1, 121, 2, 84),
	(91, '2016-08-05 19:32:38', 9, NULL, 11, 4, 1, NULL),
	(92, '2016-08-05 19:33:50', 9, NULL, 11, 5, 1, NULL),
	(93, '2016-08-05 19:32:44', 9, 20, 1, 14, 1, NULL),
	(94, '2016-08-05 19:29:17', 9, 20, 8, 1, 1, NULL),
	(95, '2016-08-05 19:32:47', 9, 21, 7, 16, 1, NULL),
	(96, '2016-08-05 19:32:52', 9, 22, 2, 17, 1, NULL),
	(97, '2016-08-05 19:32:51', 9, 22, 3, 17, 1, NULL),
	(98, '2016-08-05 19:33:39', 9, NULL, 11, 124, 2, 91),
	(99, '2016-08-05 19:33:29', 9, 20, 1, 121, 2, 93);
