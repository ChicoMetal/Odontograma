...
) ENGINE=InnoDB AUTO_INCREMENT=76 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='almacena las citas programadas';
...
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='Almacena las diferentes historias odontologicas que se abren a los pacientes';
...
-- Volcando datos para la tabla odontograma1.logs: ~54 rows (aproximadamente)
...
INSERT INTO `logs` (`id`, `usuario`, `token`, `Ingreso`, `Salida`, `estado`) VALUES
	...
	(63, 'maria', '7eb3dbccc6a91484a03d57af2e3656e7', '2016-08-18 17:46:37', NULL, b'1');
...
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='Aqui se almacena la razon por la que el paciente acude a consulta';

-- Volcando datos para la tabla odontograma1.motivosconsulta: ~1 rows (aproximadamente)
