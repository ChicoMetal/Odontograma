...
-- Volcando datos para la tabla odontograma1.items: ~7 rows (aproximadamente)
...
INSERT INTO `items` (`Id`, `Codigo`, `Nombre`, `Descripcion`, `resource`, `Representacion`, `GroupParent`, `Zone`) VALUES
	...
	(2, 'K001', 'Dientes Supernumerarios', '--', NULL, 2, 1, 8),
	(3, 'K002', 'Anomalias Del Tamaño Y De La Forma Del Diente', '--', NULL, 2, 1, 8),
...
-- Volcando datos para la tabla odontograma1.pacienteprocedures: ~34 rows (aproximadamente)
