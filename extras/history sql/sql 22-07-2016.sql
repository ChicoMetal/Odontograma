...
-- Volcando datos para la tabla odontograma1.admisiones: ~3 rows (aproximadamente)
...
-- Volcando datos para la tabla odontograma1.evoluciones: ~9 rows (aproximadamente)
...
-- Volcando datos para la tabla odontograma1.pacienteprocedures: ~41 rows (aproximadamente)
