...
-- Volcando datos para la tabla odontograma1.dientes: ~3 rows (aproximadamente)
...
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='Almacena las evoluciones que se le den a los diagnosticos del paciente';
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='Almacena las diferentes historias odontologicas que se abren a los pacientes';

-- Volcando datos para la tabla odontograma1.historias: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `historias` DISABLE KEYS */;
INSERT INTO `historias` (`Codigo`, `Paciente`, `FechaApertura`, `Estado`, `Padre`) VALUES
	(2, 1104, '2016-05-31 12:01:47', b'1', NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=328 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci;

-- Volcando datos para la tabla odontograma1.pacienteprocedures: ~51 rows (aproximadamente)
...
INSERT INTO `pacienteprocedures` (`Id`, `Fecha`, `Historia`, `Diente`, `Zone`, `Procedure`, `Tipe`, `Cause`) VALUES
	(2, '2015-12-22 12:06:51', 2, 35, 8, 110, 1, NULL),
	...
	(290, '2016-05-31 22:55:24', 2, NULL, 11, 3, 1, NULL),
	(291, '2016-06-06 00:34:34', 2, 11, 1, 121, 2, 200),
	(292, '2016-06-06 00:57:20', 2, 8, 8, 122, 2, 179),
	(293, '2016-06-06 00:58:52', 2, 5, 9, 123, 2, 189),
	(315, '2016-06-06 01:11:10', 2, 38, 1, 13, 1, NULL),
	(316, '2016-06-06 14:30:11', 2, 45, 1, 121, 2, 202),
	(323, '2016-06-07 21:45:15', 2, NULL, 11, 124, 2, 290),
	(324, '2016-06-07 21:55:47', 2, 38, 1, 121, 2, 315),
	(325, '2016-06-07 21:55:53', 2, 38, 8, 122, 2, 159),
	(326, '2016-06-07 21:56:15', 2, 33, 9, 123, 2, 212),
...
-- Volcando datos para la tabla odontograma1.tipeitems: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla odontograma1.ubicaciones: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla odontograma1.zones: ~0 rows (aproximadamente)
