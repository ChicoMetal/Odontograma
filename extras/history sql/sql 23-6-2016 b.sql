...
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci COMMENT='almacena las citas programadas';
...
-- Volcando datos para la tabla odontograma1.pacienteprocedures: ~48 rows (aproximadamente)
...
INSERT INTO `pacientes` (`Id`, `Tipoid`, `Nombres`, `Apellidos`, `Edad`, `Sexo`, `Telefono`, `Celular`, `Direccion`, `Estado`) VALUES
	(1104, 'CC', 'carlos', 'guzman', 24, 'M', '300', '300', 'sincelejo', b'1');
...
INSERT INTO `usuarios` (`Id`, `Tipoid`, `Nombres`, `Apellidos`, `Edad`, `Sexo`, `Telefono`, `Celular`, `Direccion`, `Usuario`, `Password`, `Estado`, `Tipo`) VALUES
	(0, 'CC', '92654', 'ana', 30, 'F', '280000', '31284563', 'sincelej', 'ana', 'ana', b'1', '1111');
